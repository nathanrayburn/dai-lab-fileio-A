...
import ch.heig.dai.lab.fileio.LucasHSN.Transformer;
...
public class TransformerTest {
    ...
    private final ch.heig.dai.lab.fileio.LucasHSN.Transformer transformer = new Transformer(newName, numWordsPerLine);
