...
import ch.heig.dai.lab.fileio.evarayHEIG.Transformer;
...
public class TransformerTest {
    ...
    private final ch.heig.dai.lab.fileio.evarayHEIG.Transformer transformer = new Transformer(newName, numWordsPerLine);
