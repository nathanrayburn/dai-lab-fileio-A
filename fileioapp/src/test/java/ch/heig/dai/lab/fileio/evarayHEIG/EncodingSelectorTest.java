...
import ch.heig.dai.lab.fileio.evarayHEIG.EncodingSelector;
...
public class EncodingSelectorTest {
    ...
    private final ch.heig.dai.lab.fileio.evarayHEIG.EncodingSelector selector = new EncodingSelector();
