...
import ch.heig.dai.lab.fileio.Sinaf19.Transformer;
...
public class TransformerTest {
    ...
    private final ch.heig.dai.lab.fileio.Sinaf19.Transformer transformer = new Transformer(newName, numWordsPerLine);
